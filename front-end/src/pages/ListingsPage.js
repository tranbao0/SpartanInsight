    ...
    if (activeView === 'professors') {
      return (
        <>
          ...
          <div className="login-prompt">
            <p>Want to add reviews or professors? <button onClick={() => navigate('/login')}>Log In</button> or <button onClick={() => navigate('/signup')}>Sign Up</button></p>
          </div>
        </>
      );
    } else {
      return (
        <>
          ...
          <div className="login-prompt">
            <p>Want to add reviews or courses? <button onClick={() => navigate('/login')}>Log In</button> or <button onClick={() => navigate('/signup')}>Sign Up</button></p>
          </div>
        </>
      );
    }
